...
const Home = () => {
  ...
  const testimonials = [
    {
      name: "Rahul Sharma",
      quote:
        "Excellent service! My medicines were delivered within hours. Very reliable pharmacy.",
      rating: 5,
    },
    {
      name: "Priya Patel",
      quote:
        "Genuine medicines at affordable prices. The staff is very knowledgeable and helpful.",
      rating: 5,
    },
    {
      name: "Vikram Singh",
      quote:
        "Best pharmacy in Jalgaon. Home delivery service is a lifesaver for elderly parents.",
      rating: 5,
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-100">
            ...
            <div className="md:w-1/2 mb-12 md:mb-0">
              ...
              <FadeIn delay={0.2}>
                <p className="text-lg md:text-xl text-blue-100 mb-8 max-w-2xl">
                  Your one-stop destination for genuine medicines, wellness
                  products, and reliable home delivery service in <a target="_blank" href="https://maps.app.goo.gl/BHnqLhoDYkz7uwqb9">
                       Jalgaon
                      </a>.
                </p>
              </FadeIn>
          ...
          <FadeIn>
            <div className="text-center mb-12 md:mb-16">
              ...
              <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
                Committed to delivering affordable and genuine healthcare
                products to the community of Jalgaon
              </p>
            </div>
          </FadeIn>
            ...
            <SlideIn direction="left" className="md:w-1/2">
              ...
              >
                ...
                <p className="text-base md:text-lg mb-6">
                  To make medicines and wellness essentials easily accessible to
                  everyone with trust and care. With years of dedication, we
                  have become a reliable name for families and patients.
                </p>
              ...
              <div className="grid grid-cols-2 gap-4 md:gap-6">
                {[
                  ...
                  },
                  {
                    icon: "🏠",
                    title: "Home Delivery",
                    desc: "Free delivery in Jalgaon",
                  },
                  {
                    icon: "⏰",
                    title: "Quick Service",
                    desc: "Fast prescription processing",
                  },
                  {
                    icon: "💰",
                    title: "Best Prices",
      ...
      <section
        id="products"
        className="py-16 md:py-20 bg-gradient-to-br from-blue-50 to-cyan-100"
      >
        <div className="container mx-auto px-6">
          <FadeIn>
            <div className="text-center mb-12 md:mb-16">
        ...
        <div className="container mx-auto px-6 text-center">
          <FadeIn>
            ...
            <p className="text-lg md:text-xl mb-6 md:mb-8 max-w-2xl mx-auto">
              Send us your doctor's prescription and get your medicines
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Your trusted healthcare partner in Jalgaon, providing genuine
