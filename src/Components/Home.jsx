...
const Home = () => {
  const services = [
    ...
    },
    {
      ...
      title: "Clinics",
      description: "Regular health check-ups and specialist consultations",
    },
    {
    ...
    },
    {
      ...
      title: "Specialists",
      description: "Experienced doctors across multiple specialties",
    },
  ];
  ...
  const testimonials = [
    {
      name: "Rahul Sharma",
      quote:
        "Excellent service and knowledgeable staff. My prescription was ready in minutes!",
    },
    {
      name: "Priya Patel",
      quote:
        "The doctors here are very patient and explain everything clearly.",
    },
    {
      name: "Vikram Singh",
      quote:
        "Clean facility with modern equipment. Highly recommended.",
    },
  ];
  ...
  return (
    <div className="bg-gray-50">
      ...
      <div className="relative bg-blue-800 text-white">
        <div className="container mx-auto px-6 py-12 md:py-24 flex flex-col md:flex-row items-center gap-10">
          <div className="md:w-1/2 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <button className="bg-white text-blue-800 px-6 py-3 rounded-lg font-semibold hover:bg-blue-100 transition">
                Order Before
              </button>
      ...
      <div className="bg-blue-700 text-white py-16">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto">
            Our team of healthcare professionals is ready to help you with all
            your medical needs.
          </p>
          <button className="border-2 border-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-800 transition duration-300 flex items-center justify-center gap-2 mx-auto">
            <FaPhoneAlt /> Call Now
          </button>
        </div>
      </div>
      ...
      <div className="bg-gray-100 py-12">
        <div className="container mx-auto px-6">
          <div className="bg-white rounded-xl shadow-md p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
